        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="scp4.php?item=SCP-004">SCP-004</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container-fluid mt-5">
        <div class="scp">
            ...
            ?>
                    ...
                    <?php endif; ?>
                    <div class="p-3">
                        <p><strong>Special Containment Procedures:</strong><br><?php echo nl2br(htmlspecialchars($row['procedures'])); ?></p>
                        <p><strong>Description:</strong><br><?php echo nl2br(htmlspecialchars($row['description'])); ?></p>
                        <?php if (!empty($row['reference'])): ?>
                            <p><strong>Reference:</strong><br><?php echo nl2br(htmlspecialchars($row['reference'])); ?></p>
                        <?php endif; ?>
                    </div>

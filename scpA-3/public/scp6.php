        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="scp6.php?item=SCP-006">SCP-006</a>
                    </li>
                </ul>
            </div>
        </nav>
    ...
    <div class="container-fluid mt-5">
        <div class="scp">
            ...
            ?>
                    ...
                    <h3>Object: <?php echo isset($row['object_class']) ? htmlspecialchars($row['object_class']) : 'Object not specified'; ?></h3>
            ...
            <?php
                    ...
                    echo "<p>No SCP entry found for item '$item'.</p>";
                }
